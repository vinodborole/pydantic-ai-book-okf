...
The simplest way to enable thinking across supported providers is the [ Thinking](/docs/ai/api/pydantic-ai/capabilities/#pydantic_ai.capabilities.Thinking) capability.
...
1. Source page: https://pydantic.dev/docs/ai/advanced-features/thinking
