...
| [Runtime Authoring](/docs/ai/harness/runtime-authoring) | Lets an agent author, validate, and load real capabilities at runtime. | — | 
| [Guardrails](/docs/ai/harness/guardrails) | Validates user input before a run starts and model output after it completes — block or redact, with structured results. | — | 
