...
For most application use cases, the higher-level `Agent` API provides a more convenient interface with additional features such as native tool execution, retrying, structured output parsing, and more.
