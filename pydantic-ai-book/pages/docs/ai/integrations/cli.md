...
| `--tool` ,`-t` | [Native tool](/docs/ai/tools-toolsets/native-tools/) s to list as options in the UI (repeatable). See[available tools](/docs/ai/guides/web/#native-tool-support) . | 
...
| `--allowed-host` | Hostname to answer to in addition to IP addresses and `localhost` (repeatable). See[Reaching the UI under a hostname](/docs/ai/guides/web/#reaching-the-ui-under-a-hostname) . | 
