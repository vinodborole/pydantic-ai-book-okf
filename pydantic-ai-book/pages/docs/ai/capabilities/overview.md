...
| [`ImageGeneration`](/docs/ai/api/pydantic-ai/capabilities/#pydantic_ai.capabilities.ImageGeneration) | Subagent via `fallback_subagent_model=` | Delegates to a model that supports native image generation | 
