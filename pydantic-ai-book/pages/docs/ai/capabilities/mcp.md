...
[ MCP](/docs/ai/api/pydantic-ai/capabilities/#pydantic_ai.capabilities.MCP) is a 

[provider-adaptive capability](/docs/ai/capabilities/overview#provider-adaptive-tools)and the primary entry point for
...
[MCP Server Tool](/docs/ai/tools-toolsets/native-tools#mcp-server-tool)for provider support and configuration) — pass
