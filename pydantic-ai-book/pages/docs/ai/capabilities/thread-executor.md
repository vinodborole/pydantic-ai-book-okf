...
```
It declares a default `id` of `'use_thread_executor'`, so two instances merge instead of raising a duplicate-id error — see [building custom capabilities](/docs/ai/capabilities/custom/) for the merge rules.
