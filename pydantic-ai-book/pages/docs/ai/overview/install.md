...
`pydantic-ai-examples`To install examples, use the `examples` optional group:
...
[, you would run:](/docs/ai/api/models/openai/#pydantic_ai.models.openai.OpenAIChatModel)

`OpenAIChatModel``pydantic-ai-slim` has the following optional groups:
