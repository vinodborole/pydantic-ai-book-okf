---
type: Web Page
title: Multi-agent Applications | Pydantic Docs
...
4. [Graph based control flow](/docs/ai/graph/graph/) — for the most complex cases, a graph-based state machine can be used to control the execution of multiple agents
...
- **Durable execution** — preserving agent state across transient API failures and application errors or restarts. See[Durable Execution](/docs/ai/capabilities/durable_execution/overview/) .
