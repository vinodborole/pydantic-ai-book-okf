...
| `ToolCorrectness` | Required tool coverage | Multiset of tool names invoked | 
| `TrajectoryMatch` | Tool-call sequence quality | F1 against expected trajectory | 
| `ArgumentCorrectness` | Tool argument checks | Refund `order_id`, search query | 
| `MaxToolCalls` | Budget discipline | Tool-call budget | 
| `MaxModelRequests` | Budget discipline | Model-request budget | 
...
1. Source page: https://pydantic.dev/docs/ai/evals/evaluators/overview
